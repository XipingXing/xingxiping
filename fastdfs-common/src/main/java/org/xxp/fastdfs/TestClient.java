...
import org.xxp.fastdfs.core.ProtoCommon;
import org.xxp.fastdfs.core.ServerInfo;
import org.xxp.fastdfs.core.StorageClient;
  	...
  	try
  	{
  		...
  		*/
  		...
  		if (results != null)
  		{
  			...
  			errno = client.download_file(group_name, remote_filename, 0, 0, "d:\\" + remote_filename.replaceAll("/", "_"));
  			if (errno == 0)
  			{
  			...
  			errno = client.download_file(group_name, remote_filename, 0, 0, new DownloadFileWriter("d:\\" + remote_filename.replaceAll("/", "-")));
  			if (errno == 0)
  			{
  				System.err.println("Download file success");
  			}
