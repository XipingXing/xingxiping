...
import org.xxp.fastdfs.common.IniFileReader;
import org.xxp.fastdfs.common.MyException;
import org.xxp.fastdfs.pool.PoolBean;
...
*/
	 ...
	 * @param iniReader
	 */
	private static void initPoolBean(IniFileReader iniReader, String conf_filename){
	  bean = new PoolBean();
